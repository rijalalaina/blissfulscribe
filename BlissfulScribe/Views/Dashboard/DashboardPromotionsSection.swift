            ...
            HStack(alignment: .top, spacing: 18) {
                if shouldShowUpgradePromotion {
                    DashboardPromotionCard(
                        badge: "30% OFF",
                        title: "Unlock BlissfulScribe Pro For Less",
                        message: "Share BlissfulScribe on your socials, and instantly unlock a 30% discount on BlissfulScribe Pro.",
                ...
                if shouldShowAffiliatePromotion {
                    DashboardPromotionCard(
                        badge: "AFFILIATE 30%",
                        title: "Earn With The BlissfulScribe Affiliate Program",
                        message: "Share BlissfulScribe with friends or your audience and receive 30% on every referral that upgrades.",
