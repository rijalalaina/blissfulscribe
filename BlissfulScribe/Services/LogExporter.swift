...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.goodtogreatmind.blissfulscribe", category: "LogExporter")
    private let subsystem = "com.goodtogreatmind.blissfulscribe"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== BlissfulScribe Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "BlissfulScribe_Logs_\(timestamp).log"
