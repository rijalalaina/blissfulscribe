...
enum BlissfulScribeEngineError: Error, Identifiable {
...
extension BlissfulScribeEngineError: LocalizedError {
...
typealias WhisperStateError = BlissfulScribeEngineError
