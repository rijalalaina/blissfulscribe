...
class MenuBarManager: ObservableObject {
    private let logger = Logger(subsystem: "com.goodtogreatmind.blissfulscribe", category: "MenuBarManager")
    ...
    private var engine: BlissfulScribeEngine?
    ...
    func configure(modelContainer: ModelContainer, engine: BlissfulScribeEngine) {
