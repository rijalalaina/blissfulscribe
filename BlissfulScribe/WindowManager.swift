...
class WindowManager: NSObject {
    ...
    private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("com.goodtogreatmind.blissfulscribe.mainWindow")
    private static let mainWindowAutosaveName = NSWindow.FrameAutosaveName("BlissfulScribeMainWindowFrame")

    private let logger = Logger(subsystem: "com.goodtogreatmind.blissfulscribe", category: "WindowManager")
