...
struct EmailSupport {
    private static let supportEmailAddress = "support@scribe.blissfulplan.com"
    ...
    static func generateSupportEmailBody() -> String {
        ...
        ## 📋 COMMON ISSUES:
        Check out our Common Issues page before sending an email: https://scribe.blissfulplan.com/common-issues
        ------------------------
