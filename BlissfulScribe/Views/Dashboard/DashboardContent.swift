...
struct DashboardContent: View {
    private let logger = Logger(subsystem: "com.goodtogreatmind.blissfulscribe", category: "DashboardContent")
    ...
    private var licenseStatusMessage: some View {
        ...
        case .unlicensed:
            TrialMessageView(
                message: Text("Activate a license to continue using BlissfulScribe."),
        ...
        VStack(spacing: 10) {
            HStack {
                ...
                if hasLoadedStatsSnapshot {
                    ...
                    Text("You have saved \(highlightedTime) with BlissfulScribe")
                        .fontWeight(.bold)
                        .foregroundColor(.white.opacity(0.85))
                        .font(.system(size: 30))
                        .multilineTextAlignment(.center)
                } else {
                    Text("BlissfulScribe Insights")
    ...
    private var voiceInkStatsSection: some View {
        LazyVGrid(columns: [GridItem(.adaptive(minimum: 240), spacing: 16)], spacing: 16) {
            DashboardStatCard(
                ...
                detail: "BlissfulScribe sessions completed",
            ...
            DashboardStatCard(
                ...
                value: hasLoadedStatsSnapshot && averageWordsPerMinute > 0
                    ...
                    : "–",
                detail: "BlissfulScribe vs. typing by hand",
    ...
    private var heroSubtitle: String {
        ...
        guard totalCount > 0 else {
            return String(localized: "Your BlissfulScribe journey starts with your first recording.")
        }
    ...
    var body: some View {
        HStack(alignment: .center, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 3) {
                ...
                Text("Required for BlissfulScribe shortcuts and app-wide controls to work properly.")
                    .font(.system(size: 11))
