...
final class SoundPlaybackEngine: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.goodtogreatmind.blissfulscribe.soundPlayback", qos: .userInitiated)
    private let logger = Logger(subsystem: "com.goodtogreatmind.blissfulscribe", category: "SoundPlaybackEngine")
