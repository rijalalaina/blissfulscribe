...
class AudioTranscriptionManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.goodtogreatmind.blissfulscribe", category: "AudioTranscriptionManager")
    ...
    func startProcessing(modelContext: ModelContext, engine: BlissfulScribeEngine, mode: ModeConfig) {
