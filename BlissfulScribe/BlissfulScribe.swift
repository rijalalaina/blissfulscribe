...
@main
struct BlissfulScribeApp: App {
    @NSApplicationDelegateAdaptor(AppDelegate.self) var appDelegate
    let container: ModelContainer

    @StateObject private var engine: BlissfulScribeEngine
    ...
    init() {
        ...
        do {
            ...
            do {
                ...
                DispatchQueue.main.async {
                    ...
                    alert.informativeText = String(localized: "BlissfulScribe couldn't access its storage location. Your transcriptions will not be saved between sessions.")
                ...
                fatalError("BlissfulScribe failed to initialize storage.\nPersistent:\n\(persistentDetail)\nIn-memory:\n\(memoryDetail)")
            }
        }
        ...
        let appSupportDirectory = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
            .appendingPathComponent("com.goodtogreatmind.BlissfulScribe")
        ...
        // 4. Create engine
        let engine = BlissfulScribeEngine(
    ...
    private static func createPersistentContainer(schema: Schema, logger: Logger) throws -> ModelContainer {
        let appSupportURL = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
            .appendingPathComponent("com.goodtogreatmind.BlissfulScribe", isDirectory: true)
        ...
        #else
        let dictionaryCloudKit: ModelConfiguration.CloudKitDatabase = .private("iCloud.com.goodtogreatmind.BlissfulScribe")
        #endif
