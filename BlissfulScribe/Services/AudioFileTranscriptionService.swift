...
class AudioTranscriptionService: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.goodtogreatmind.blissfulscribe", category: "AudioTranscriptionService")
    ...
    init(modelContext: ModelContext, engine: BlissfulScribeEngine) {
