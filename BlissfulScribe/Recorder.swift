...
class Recorder: NSObject, ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.goodtogreatmind.blissfulscribe", category: "Recorder")
    ...
    private let audioMeterQueue = DispatchQueue(label: "com.goodtogreatmind.blissfulscribe.audiometer", qos: .userInteractive)
    /// Dedicated serial queue for hardware setup.
    private let audioSetupQueue = DispatchQueue(label: "com.goodtogreatmind.blissfulscribe.audioSetup", qos: .userInitiated)
