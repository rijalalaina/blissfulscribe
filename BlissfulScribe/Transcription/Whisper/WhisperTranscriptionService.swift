...
class WhisperTranscriptionService: TranscriptionService {
    ...
    private let logger = Logger(subsystem: "com.goodtogreatmind.blissfulscribe", category: "WhisperTranscriptionService")
    ...
    func transcribe(audioURL: URL, model: any TranscriptionModel, context: TranscriptionRequestContext) async throws -> String {
        ...
        guard success else {
            ...
            throw BlissfulScribeEngineError.whisperCoreFailed
        }
