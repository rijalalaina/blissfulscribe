...
struct SettingsView: View {
    ...
    @AppStorage(AppAppearance.userDefaultsKey) private var appThemeRaw = AppAppearance.system.rawValue
        ...
        Form {
            ...
            Section("Pasting") {
                ExpandableSettingsRow(
                    ...
                    infoMessage: "BlissfulScribe temporarily uses the clipboard to paste transcription. When enabled, it restores your previous clipboard content after the selected delay. When disabled, the pasted transcription stays on your clipboard."
                ) {
            ...
            Section("Interface") {
                Picker("Appearance", selection: $appThemeRaw) {
                    ForEach(AppAppearance.allCases, id: \.rawValue) { theme in
            ...
            Section {
                ...
                Text("Control how BlissfulScribe handles your transcription data and audio recordings.")
            }
