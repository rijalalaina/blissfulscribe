<div align="center">
  <img src="BlissfulScribe/Assets.xcassets/AppIcon.appiconset/256-mac.png" width="180" height="180" />
  <h1>BlissfulScribe</h1>
  <p>Voice to text app for macOS to transcribe what you say to text almost instantly</p>

  [![License](https://img.shields.io/badge/License-GPL%20v3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)
  ![Platform](https://img.shields.io/badge/platform-macOS%2014.0%2B-brightgreen)
  [![GitHub release (latest by date)](https://img.shields.io/github/v/release/Beingpax/BlissfulScribe)](https://github.com/Beingpax/BlissfulScribe/releases)
...
```shell
brew install --cask blissfulscribe
```

### Build from Source
As an open-source project, you can build BlissfulScribe yourself by following the instructions in [BUILDING.md](BUILDING.md). However, the compiled version includes additional benefits like automatic updates, priority support via Discord and email, and helps fund ongoing development.
...
- [Contributing Guidelines](CONTRIBUTING.md) - How to contribute to BlissfulScribe
- [Code of Conduct](CODE_OF_CONDUCT.md) - Our community standards

## Contributing

This project is **not accepting pull requests** at this time. You're welcome to fork and modify BlissfulScribe for your own use.

You can still contribute by:
- Reporting bugs via [issues](https://github.com/Beingpax/BlissfulScribe/issues)
...
- [Sparkle](https://github.com/sparkle-project/Sparkle) - Keeping BlissfulScribe up to date
